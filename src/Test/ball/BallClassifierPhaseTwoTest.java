...
public class BallClassifierPhaseTwoTest {
    ...
    void pairBallTest() throws NoWaypointException {
         ...
         */
        ballsToAvoid.add(new Ball(new Vector2Dv1(185, 228)));
        ballsToAvoid.add(new Ball(new Vector2Dv1(186, 267)));
        ...
        assertEquals((int) ballsToAvoid.get(0).getPickUpPoint().x, 115);
        assertEquals((int) ballsToAvoid.get(1).getPickUpPoint().x, 255);
        assertEquals((int) ballsToAvoid.get(2).getPickUpPoint().x, 100);

        assertEquals((int) ballsToAvoid.get(0).getPickUpPoint().y, 229);
        assertEquals((int) ballsToAvoid.get(1).getPickUpPoint().y, 265);
